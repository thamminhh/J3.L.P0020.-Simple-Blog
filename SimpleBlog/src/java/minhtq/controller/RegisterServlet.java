...
public class RegisterServlet extends HttpServlet {
    ...
    private final String REGISTER_ACCOUNT_PAGE = "registerPage";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = (String) siteMap.get(REGISTER_ACCOUNT_PAGE);
        ...
        try {
            ...
            if (error) {
                ...
                boolean result = dao.insertAccount(email, password, fullname, false, "New");
                if (result) {
